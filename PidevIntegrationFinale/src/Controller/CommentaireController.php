...
class CommentaireController extends AbstractController
{
    ...
    /**
     * @Route("/{id}", name="commentaire_showfront", methods={"GET"})
     */
    public function commentaireshowfront(Commentaire $commentaire): Response
    {

        return $this->render('commentaire/commentaire_showfront.html.twig', [
            'commentaire' => $commentaire,
        ]);
    }
